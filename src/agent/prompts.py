...
9. После вызова parse_transactions_from_text — ОБЯЗАТЕЛЬНО покажи пользователю что именно сохранено: список транзакций с датой, суммой и категорией. Не заменяй подтверждение на свои вопросы или советы
